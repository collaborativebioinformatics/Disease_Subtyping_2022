...
To confirm the idea that the efficacy of treatment varies based on subtypes of patients, we have performed survival analysis on the colorectal patients stratified by subtypes and treatment groups, which is seen in our script found in "scripts" folder. This function allows you to input a subtype and treatment groups that you want to compare, and then it returns overall survival of such patient with a certain subtype and treatments. This analysis showed that CMS4 patients received bevacizumab,fluorouracil,leucovorin, and irinotecan survied longer than those received only fluorouracil,leucovorin, and irinotecan. On the other hand, CMS1 patients bevacizumab,fluorouracil,leucovorin, and irinotecan survived shorter than those received only fluorouracil,leucovorin, and irinotecan. This result supports our idea on a subtype determines the efficacy of treatments. This survival analysis platform can be used for users to determine which treatment is best for a particular subtype of patient.
