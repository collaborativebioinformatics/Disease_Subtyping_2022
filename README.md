...
To further refine this approach to precision medicine, we then built out a method to perform RNA-seq or microarray analysis on colon cancer data searching for differentially (over/under) expressed genes that the have been demonstrated in a paper by <colotype paper first author>, et al [^1] to be associated with different subtypes of colorectal cancer.  Our method also analyzes 12 different reported driver genes [^20](other REFs needed!) for colorectal cancer (table 1), and associates them with various subtypes (Figure 1 a-d).  For the purposes of this manuscript, we show the top ten driver (or combination there of) subtype combinations, outlined in the radar plots shown in figure 2.  


![Figure 2]([https://github.com/collaborativebioinformatics/Disease_Subtyping_2022/radar_plots/cms1_radar_plot.png](https://github.com/collaborativebioinformatics/Disease_Subtyping_2022/blob/main/radar_plots/cms1_radar_plot.png))
